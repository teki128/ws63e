...
enum spooky_encoder_init_res spooky_encoder_init(struct spooky_encoder *enc,
                                                 uint8_t *buffer,
                                                 uint8_t buffer_size,
                                                 uint8_t tx_rate)
{
...
enum spooky_encoder_enqueue_res spooky_encoder_enqueue(struct spooky_encoder *enc, uint8_t *input, uint8_t input_size)
{
    if (enc->mode != TX_NONE)
...
enum spooky_encoder_clear_res spooky_encoder_clear(struct spooky_encoder *enc)
{
    if (enc == NULL)
...
enum spooky_encoder_step_res spooky_encoder_step(struct spooky_encoder *enc)
{
